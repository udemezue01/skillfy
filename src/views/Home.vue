<template>
  ...
  <!--   The Hero section -->
    ...
    <section class="flex-wrap xl:flex justify-between">
   ...
   <!--  End of the Hero section -->
        ...
        <section class="p-4 bg-gray-50">
          ...
          <h2 class="text-3xl text-center font-body text-transparent font-extrabold tracking-wider bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600"> How It Works </h2>
